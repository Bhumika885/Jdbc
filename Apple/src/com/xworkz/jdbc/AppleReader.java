  ...
  import java.sql.Connection;
	...
	public class AppleReader {
		public static void main(String[] args) {
			...
			String query1 = "SELECT name FROM application WHERE email = 'arvind23@gmail.com' AND mobileNo = 8122407324";
			String query2 = "SELECT address FROM application WHERE name = 'Manjesh' AND mobileNo = 6381500876";
			String query3 = "SELECT email FROM application where id=10 AND mobileNo=9609255412";
			String query4 = "SELECT email ,aadhaarNo FROM application where mobileNo = 9047500110 AND name = 'Tharun'";
